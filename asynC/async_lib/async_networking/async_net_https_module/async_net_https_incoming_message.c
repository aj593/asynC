...
enum async_net_https_incoming_message_events {
    async_net_https_incoming_message_data_event,
    async_net_https_incoming_message_end_event,
    async_net_https_incoming_message_trailers_event
};
...
void async_net_https_incoming_message_init(
    async_net_https_incoming_message* incoming_msg,
...
void async_net_https_incoming_message_destroy(async_net_https_incoming_message* incoming_msg);

int https_double_CRLF_check_and_enqueue_parse_task(
    async_net_https_incoming_message* incoming_msg_ptr,
    async_tls_socket* read_socket,
    async_byte_buffer* data_buffer,
    void data_handler_to_remove(async_tls_socket*, async_byte_buffer*, void*),
    void(*after_parse_task)(void*, void*),
    void* thread_cb_arg
);

int async_net_https_incoming_message_double_CRLF_check(
    async_net_https_incoming_message* incoming_msg_ptr,
    async_tls_socket* read_socket,
...
void async_net_https_incoming_message_parse(void* incoming_msg_ptr_arg);
void async_net_https_incoming_message_data_handler(async_tls_socket* socket, async_byte_buffer* data, void* arg);
void async_net_https_incoming_message_check_data(async_net_https_incoming_message* incoming_msg_ptr);

int async_net_https_incoming_message_chunk_handler(
    async_net_https_incoming_message* incoming_msg_ptr, 
...
int async_net_https_incoming_message_process_trailers(
    async_net_https_incoming_message* incoming_msg_ptr,
    async_byte_stream_ptr_data* stream_ptr_data
);

void async_net_https_incoming_message_on_data(
    async_net_https_incoming_message* incoming_msg_ptr,
    void* type_arg, 
...
void async_net_https_incoming_message_emit_data(
    async_net_https_incoming_message* incoming_msg, 
    void* data_ptr, 
    unsigned int num_bytes
);

void https_incoming_msg_data_converter(void(*generic_callback)(void), void* type_arg, void* data, void* arg);

void async_net_https_incoming_message_on_end(
    async_net_https_incoming_message* incoming_msg, 
    void* type_arg,
...
void async_net_https_incoming_message_emit_end(async_net_https_incoming_message* incoming_msg_info);
void https_req_end_converter(void(*generic_callback)(void), void* type_arg, void* data, void* arg);
...
void async_net_https_incoming_message_init(
    ...
    async_net_https_message_template_init(
...
void async_net_https_incoming_message_destroy(async_net_https_incoming_message* incoming_msg){
    async_net_https_message_template_destroy(&incoming_msg->incoming_msg_template_info);
...
int https_double_CRLF_check_and_enqueue_parse_task(
    ...
    int double_CRLF_ret = async_net_https_incoming_message_double_CRLF_check(
        incoming_msg_ptr,
        read_socket,
        data_buffer,
    ...
    async_thread_pool_create_task(
        async_net_https_incoming_message_parse,
        after_parse_task,
        incoming_msg_ptr,
        thread_cb_arg
    );
...
int async_net_https_incoming_message_double_CRLF_check(
    async_net_https_incoming_message* incoming_message_ptr,
    async_tls_socket* read_socket,
    async_byte_buffer* new_data_buffer,
    void data_handler_to_remove(async_tls_socket*, async_byte_buffer*, void*)
){
    ...
    async_tls_socket_off_data(read_socket, data_handler_to_remove);

    async_tls_socket_on_data(
        read_socket,
        async_net_https_incoming_message_data_handler,
...
void async_net_https_incoming_message_parse(void* incoming_msg_ptr_arg){
    async_net_https_incoming_message* incoming_msg_ptr = 
        *(async_net_https_incoming_message**)incoming_msg_ptr_arg;
    ...
    async_net_https_message_template* template_ptr = &incoming_msg_ptr->incoming_msg_template_info;
...
void async_net_https_incoming_message_data_handler(async_tls_socket* socket, async_byte_buffer* data, void* arg){
    async_net_https_incoming_message* incoming_msg_ptr = (async_net_https_incoming_message*)arg;    
    ...
    async_net_https_incoming_message_check_data(incoming_msg_ptr);
}
    ...
    while(!is_async_byte_stream_empty(curr_stream_ptr)){
        ...
        if(*is_response_chunked_ptr){
            ...
            (incoming_msg_ptr->is_reading_trailers) ?
                (async_net_https_incoming_message_process_trailers(incoming_msg_ptr, &ptr_to_data)) :
                (is_set_to_emit_data = async_net_https_incoming_message_chunk_handler(
                    incoming_msg_ptr,
                    &ptr_to_data,
        ...
        if(is_set_to_emit_data){
            async_net_https_incoming_message_emit_data(incoming_msg_ptr, buffer_to_emit, num_bytes_to_emit);
        }
        
        async_byte_stream_dequeue(curr_stream_ptr, num_bytes_to_dequeue);

        async_net_https_incoming_message_emit_end(incoming_msg_ptr);
    }
}
...
void async_net_https_incoming_message_parse_trailers(void* incoming_msg_arg){
    async_net_https_incoming_message* incoming_msg_ptr = *(async_net_https_incoming_message**)incoming_msg_arg;
    async_net_https_message_template* template_ptr = &incoming_msg_ptr->incoming_msg_template_info;
...
void https_trailer_event_converter(void(*generic_callback)(void), void* type_arg, void* data, void* arg){
    void(*trailer_handler)(void*, async_util_vector*, void*) = 
        (void(*)(void*, async_util_vector*, void*))generic_callback;

    async_net_https_incoming_message* incoming_msg_ptr = (async_net_https_incoming_message*)data;
...
void async_net_https_incoming_message_emit_trailers(async_net_https_incoming_message* incoming_msg_ptr){
...
void async_net_https_incoming_message_on_trailers(
    async_net_https_incoming_message* incoming_msg_ptr, 
    void* type_arg,
...
void async_net_https_incoming_message_after_trailers_parse(void* incoming_msg_arg, void* extra_arg){
    async_net_https_incoming_message* incoming_msg_ptr = *(async_net_https_incoming_message**)incoming_msg_arg;
    async_net_https_incoming_message_emit_trailers(incoming_msg_ptr);
    async_net_https_incoming_message_emit_end(incoming_msg_ptr);
}
...
int async_net_https_incoming_message_process_trailers(
    ...
    if(double_CRLF_ptr != NULL){
        async_thread_pool_create_task(
            async_net_https_incoming_message_parse_trailers,
            async_net_https_incoming_message_after_trailers_parse,
            incoming_msg_ptr,
            NULL
        );
    }
...
void async_net_https_incoming_message_on_data(
    ...
    async_event_emitter_on_event(
        ...
        https_incoming_msg_data_converter,
...
void async_net_https_incoming_message_emit_data(async_net_https_incoming_message* incoming_msg, void* data_ptr, unsigned int num_bytes){
...
void async_net_https_incoming_message_clear(async_net_https_incoming_message* incoming_msg_info){
...
void async_net_https_incoming_message_emit_end(async_net_https_incoming_message* incoming_msg_info){
    async_net_https_message_template* template_ptr = &incoming_msg_info->incoming_msg_template_info;
    ...
    async_net_https_incoming_message_clear(incoming_msg_info);
    async_net_https_message_template_clear(template_ptr);

    async_tls_socket_off_data(template_ptr->wrapped_tls_socket, async_net_https_incoming_message_data_handler);
    
    async_tls_socket_on_data(
        template_ptr->wrapped_tls_socket,
