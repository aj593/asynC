...
output: buffer.o c_vector.o main.o event_loop.o event_emitter.o hash_table.o linked_list.o thread_pool.o async_fs.o worker_thread.o server.o async_socket.o io_uring_ops.o async_epoll_ops.o
	gcc obj/buffer.o obj/c_vector.o obj/main.o obj/event_loop.o obj/event_emitter.o obj/hash_table.o obj/linked_list.o obj/thread_pool.o obj/async_fs.o obj/worker_thread.o obj/server.o obj/async_socket.o obj/io_uring_ops.o obj/async_epoll_ops.o -o exec/main $(CFLAGS)
